(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const i of n.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&o(i)}).observe(document,{childList:!0,subtree:!0});function a(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function o(r){if(r.ep)return;r.ep=!0;const n=a(r);fetch(r.href,n)}})();const h=new URL("/dist/assets/mango.png",import.meta.url).href,y=new URL("/dist/assets/apple.png",import.meta.url).href,w=new URL("/dist/assets/potato.png",import.meta.url).href,b=new URL("/dist/assets/bread.png",import.meta.url).href,x=new URL("/dist/assets/milk.png",import.meta.url).href,v=new URL("/dist/assets/egg.png",import.meta.url).href,L=new URL("/dist/assets/vegetable.png",import.meta.url).href,C=new URL("/dist/assets/fruit.png",import.meta.url).href,q=new URL("/dist/assets/bakery.png",import.meta.url).href,I=new URL("/dist/assets/meat.png",import.meta.url).href,E=new URL("/dist/assets/dairy.png",import.meta.url).href,$=new URL("/dist/assets/snacks.png",import.meta.url).href;window.mostBoughtProducts=[{id:1,name:"Mango",price:350,quantity:"500gm",image:h||"https://via.placeholder.com/96x96?text=Mango"},{id:2,name:"Apples",price:280,quantity:"500gm",image:y||"https://via.placeholder.com/96x96?text=Apples"},{id:3,name:"Potato",price:150,quantity:"1 kg",image:w||"https://via.placeholder.com/96x96?text=Potato"},{id:4,name:"Bread",price:200,quantity:"Medium",image:b||"https://via.placeholder.com/96x96?text=Bread"},{id:5,name:"Milk",price:120,quantity:"500 ML",image:x||"https://via.placeholder.com/96x96?text=Milk"},{id:6,name:"Eggs",price:180,quantity:"6",image:v||"https://via.placeholder.com/96x96?text=Eggs"}];window.featuredCategories=[{id:1,name:"Vegetables",image:L||"https://via.placeholder.com/96x96?text=Vegetables"},{id:2,name:"Fruits",image:C||"https://via.placeholder.com/96x96?text=Fruits"},{id:3,name:"Bakery",image:q||"https://via.placeholder.com/96x96?text=Bakery"},{id:4,name:"Meat",image:I||"https://via.placeholder.com/96x96?text=Meat"},{id:5,name:"Milk & Dairy",image:E||"https://via.placeholder.com/96x96?text=Milk+Dairy"},{id:6,name:"Snacks",image:$||"https://via.placeholder.com/96x96?text=Snacks"}];new URL("/dist/assets/plus.png",import.meta.url).href;new URL("/dist/assets/minus.png",import.meta.url).href;function R(t){const e=document.createElement("div");return e.className="trigger w-50 h-53 rounded-2xl flex flex-col bg-yellow-100 gap-1 items-left p-2 hover:shadow-md shadow-orange-400 transition duration-300 text-center rounded-bl-4xl rounded-br-4xl",e.innerHTML=`
    ...
    `,e}function k(t,e){const a=document.querySelector(t);if(!a){console.warn(`Container "${t}" not found.`);return}a.innerHTML="",e.forEach(o=>{const r=R(o),n=r.querySelector(".quantity-controls"),i=r.querySelector(".add-to-cart");if(cart[o.id]){const g=cart[o.id].qty;i.style.display="none",n.classList.remove("hidden"),n.style.display="flex",n.querySelector("input").value=g}else i.style.display="",n.classList.add("hidden");a.appendChild(r)})}window.renderProducts=k;window.QuantityControls=window.QuantityControls||function(){};function M(t){const e=document.createElement("div");return e.className="w-30 h-17 md:w-35 md:h-22 bg-yellow-100 place-items-center rounded-md",e.innerHTML=`
    ...
    `,e}function U(t,e){const a=document.querySelector(t);a&&e.forEach(o=>{const r=M(o);a.appendChild(r)})}window.renderCategories=U;window.cart=window.cart||{};let s=window.cart,c=null;new URL("/dist/assets/plus.png",import.meta.url).href;new URL("/dist/assets/minus.png",import.meta.url).href;const B=new URL("/dist/assets/trash.png",import.meta.url).href;new URL("/dist/assets/close.png",import.meta.url).href;const P=document.getElementById("cart-btn");P.addEventListener("click",()=>{c=document.createElement("div"),c.className="fixed top-0 z-70 right-0 bg-white w-64 h-full overflow-y-auto",c.innerHTML=`
    ...
    `,document.body.appendChild(c);const t=c.querySelector("#close-cart");t&&!t.dataset.bound&&(t.dataset.bound="1",t.addEventListener("click",()=>{c.remove(),c=null,document.body.style.overflow=""}),u())});function l(){renderProducts("#products-container",mostBoughtProducts),u(),m()}function p(t){const e=mostBoughtProducts.find(a=>a.id===Number(t));e&&(s[e.id]?s[e.id].qty+=1:s[e.id]={...e,qty:1},l())}function f(t){s[t]&&(delete s[t],console.log(`Product ${t} removed from cart.`),l())}document.addEventListener("click",function(t){const e=t.target.closest(".add-to-cart");if(!e)return;const a=parseInt(e.dataset.id,10);p(a)});document.addEventListener("click",function(t){if(t.target.classList.contains("remove-item")){const e=parseInt(t.target.dataset.id);f(e)}});function u(){const t=document.getElementById("cart-items"),e=document.getElementById("cart-total");if(!t||!e)return;t.innerHTML="";let a=0;Object.values(s).forEach(o=>{const r=Number(o.price)||0,n=Number(o.qty)||0,i=r*n;a+=i,t.innerHTML+=`
      <div class="grid grid-cols-[1fr_3fr] gap-1 mb-2 items-center  border-b border-gray-300 pb-2">
        ...
        <div class="flex flex-col">
            ...
            `}),m(),e.innerHTML=`<span class="text-sm">Total: Rs ${a.toFixed(2)}</span>`}function m(){document.querySelectorAll(".quantity-controls").forEach(t=>{if(t.dataset.bound==="1")return;t.dataset.bound="1";const e=t.querySelector(".btn-minus"),a=t.querySelector(".btn-plus"),o=t.querySelector("input");if(!e||!a||!o)return;const r=Number(o.dataset.id);e.addEventListener("click",()=>{let n=parseInt(o.value)||1;if(n=Math.max(0,n-1),o.value=n,n===0){delete s[r],t.classList.add("hidden"),t.style.display="";const i=t.parentElement.querySelector(".add-to-cart");i&&(i.style.display="")}else s[r]&&(s[r].qty=n);l()}),a.addEventListener("click",()=>{let n=parseInt(o.value)||1;n+=1,o.value=n,s[r]&&(s[r].qty=n),l()}),o.addEventListener("input",()=>{let n=parseInt(o.value);(isNaN(n)||n<1)&&(n=1,o.value=1),s[r]&&(s[r].qty=n),l()})})}window.addToCart=p;window.removeFromCart=f;window.renderCart=u;window.QuantityControls=m;window.refreshUI=l;new URL("/dist/assets/close.png",import.meta.url).href;document.addEventListener("DOMContentLoaded",()=>{const t=window.mostBoughtProducts||[],e=window.featuredCategories||[];console.log("toggledNav DOMContentLoaded",{hasRenderProducts:typeof renderProducts=="function",hasQuantityControls:typeof QuantityControls=="function",hasRenderCategories:typeof renderCategories=="function",productsLength:t.length,categoriesLength:e.length}),typeof renderProducts=="function"&&renderProducts("#products-container",t),typeof QuantityControls=="function"&&QuantityControls(),typeof renderCategories=="function"&&renderCategories("#categories-container",e);const a=document.querySelector("#products-container");if(!a)return;const o=a.parentElement;requestAnimationFrame(()=>{const r=Math.max(0,a.scrollWidth-o.clientWidth);a.style.setProperty("--scroll-end",`-${r}px`)})});const S=document.getElementById("nav-toggle");document.getElementById("nav-menu");let d=null;S.addEventListener("click",()=>{if(d)return;d=document.createElement("div"),d.className="fixed right-0 top-0 z-[60] mt-12 bg-white w-64 h-[calc(100vh-4rem)] overflow-y-auto shadow-lg transition-transform transform ease-in-out duration-300",d.innerHTML=`
